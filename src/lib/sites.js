...
export const SITES = {
  "ranobelib.me":  { id: 3, kind: "novel", name: "RanobeLib" },
  "mangalib.me":   { id: 1, kind: "manga", name: "MangaLib" },
  "mangalib.org":  { id: 1, kind: "manga", name: "MangaLib" },
  "hentailib.me":  { id: 4, kind: "manga", name: "HentaiLib" },
  "hentailib.org": { id: 4, kind: "manga", name: "HentaiLib" },
  "slashlib.me":   { id: 2, kind: "manga", name: "SlashLib" },
  "yaoilib.me":    { id: 2, kind: "manga", name: "YaoiLib" },
};
